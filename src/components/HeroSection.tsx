  ...
  return <section className="bg-background py-8 lg:py-16">
      <div className="container mx-auto px-6">
        ...
        <div className="mb-12 lg:mb-16 relative">
          {/* Mobile Image */}
          <img src={heroImage.mobile} alt={heroImage.alt} className="w-full h-auto rounded-lg shadow-lg object-contain object-center max-h-[80vh] block md:hidden" />
          {/* Desktop Image */}
          <img src={heroImage.desktop} alt={heroImage.alt} className="w-full h-auto rounded-lg shadow-lg object-contain object-center max-h-[80vh] hidden md:block" />
        </div>
