              ...
              {heroImages.map((image, index) => (
                <CarouselItem key={index}>
                  ...
                  <img 
                    src={image.mobile} 
                    alt={image.alt}
                    className="w-full h-auto rounded-lg shadow-lg object-cover object-top max-h-[70vh] block md:hidden"
                  />
                  {/* Desktop Image */}
                  <img 
                    src={image.desktop} 
                    alt={image.alt}
                    className="w-full h-auto rounded-lg shadow-lg object-cover object-top max-h-[70vh] hidden md:block"
                  />
                </CarouselItem>
              ))}
            </CarouselContent>
