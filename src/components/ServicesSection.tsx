...
import { Users, Palette, FileText, Printer, BookOpen, Wrench, Truck, ArrowRight } from "lucide-react";
const ServicesSection = () => {
  const services = [{
    icon: Users,
    title: "Τεχνοοικονομική Συμβουλευτική",
    description: "Εξειδικευμένη συμβουλευτική για την εξέταση εναλλακτικών σεναρίων που οδηγούν στη βέλτιστη λύση για τις ανάγκες σας"
  }, {
    icon: Palette,
    ...
    icon: FileText,
    title: "Προεκτύπωση",
    description: "Λεπτομερής έλεγχος και προετοιμασία αρχείων για άψογο αποτέλεσμα στην τελική εκτύπωση"
  }, {
    icon: Printer,
    title: "Εκτύπωση",
  ...
  return <section id="services" className="bg-background py-20">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {services.map((service, index) => <Card key={index} className="group hover:shadow-lg transition-all duration-300 border-border">
