    ...
    <footer className="bg-secondary text-secondary-foreground">
      <div className="container mx-auto px-6 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div>
            <img src="https://drive.google.com/thumbnail?id=1Ot-3fGyEPdZsas2Hqa6mQaxem3pE8YlA&sz=w800" alt="ThessPrint Logo" className="h-12 w-auto mb-6" />
            ...
            <div className="flex flex-wrap gap-4">
              <img src="https://drive.google.com/thumbnail?id=1sd20U9MTqIcr4wbbQYM-PBdy5C10pVem&sz=w800" alt="ISO 9001:2015 Certification" className="h-16 w-auto" />
              <img src="https://drive.google.com/thumbnail?id=14uiTRdsTaXPujZr_sdtA_CWPwo5rDF1H&sz=w800" alt="ISO 14001:2015 Certification" className="h-16 w-auto" />
              <img src="https://drive.google.com/thumbnail?id=1ji9HITsijBvSHDKMLw3SjwV35-HbsNMX&sz=w800" alt="FSC Certification" className="h-16 w-auto" />
            </div>
          </div>
